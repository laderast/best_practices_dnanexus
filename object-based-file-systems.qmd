...
- You are a data manager or engineer wanting to adapt your data policies to the DNAnexus platform. 
...
This is quite nice in that you are not doubly charged for storage on the platform. You do have the ability to [clone files](https://documentation.dnanexus.com/developer/api/data-containers/cloning#specification) into a different project - if you clone a file, a new physical copy of the data is created.  
