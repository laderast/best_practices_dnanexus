...
1. On UKB RAP, there is a `Bulk/` File Folder that contains many of the files you want to analyze.
...
Pheno and Processed Geno Data are stored within multiple Spark databases. These physical databases are accessed through a single object called the *dataset*.
